...
function TestimonialCard({ item }: { item: TestimonialV2Item }) {
  ...
  return (
    <motion.div
      ...
      className="section-card max-w-xs w-full cursor-default select-none rounded-3xl p-8 transition-all duration-300 group focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 md:p-10"
    >
