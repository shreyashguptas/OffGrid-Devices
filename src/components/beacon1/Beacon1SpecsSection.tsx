    ...
    >
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid items-start gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div>
            <SectionIntro
              badge={beacon1Content.productPage.specs.badge}
              title={beacon1Content.productPage.specs.title}
              description={beacon1Content.productPage.specs.description}
              centered={false}
            />
          ...
          <div className="space-y-6">
            ...
            <div className="section-card rounded-[2rem] p-6 md:p-8">
              ...
              <p className="mt-3 text-base leading-relaxed text-muted-light">
                {beacon1Content.productPage.specs.firmwareDescription}
              </p>
            </div>
          </div>
        </div>
