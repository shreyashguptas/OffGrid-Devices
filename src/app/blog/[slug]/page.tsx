...
const blogPostsData: Record<string, BlogPost> = {
  "getting-started-with-meshtastic": {
    ...
    sections: [
      { type: "paragraph", content: "OffGrid is for staying in touch when the grid isn’t reliable—hikes, events, travel, or backup comms when towers are overloaded or down. You’re not buying a concept; you’re holding a radio that’s already set up to join a mesh." },
      ...
      { type: "heading", content: "What you skip with OffGrid" },
      { type: "paragraph", content: "Your device ships with Meshtastic already installed and paired to our hardware. You don’t hunt down a board, flash firmware, or debug a first boot before you’ve sent a single message. The job left to you is the fun part: open the app, pair, and use the network." },
      ...
      { type: "paragraph", content: "Install the official app on the phone you’ll use with OffGrid:" },
      { type: "list", items: ["iOS: App Store", "Android: Google Play"] },
      { type: "heading", content: "Step 2: Pair your OffGrid" },
      { type: "paragraph", content: "Bluetooth links your phone to the radio. With Meshtastic already on the device, you’re connecting—not provisioning from scratch." },
      { type: "orderedList", items: ["Enable Bluetooth on your phone", "Open the Meshtastic app", "Tap “+” to add a device", "Choose your OffGrid from the list and complete pairing"] },
      ...
      { type: "paragraph", content: "That’s it—you’re participating in the same decentralized mesh as other Meshtastic users nearby. Range depends on terrain, antennas, and how many nodes relay between you and your destination, but you’ve cleared the usual “day one” hurdle: the software is already on the radio. Go test with a friend in the field when you can." },
    ],
  },
};
